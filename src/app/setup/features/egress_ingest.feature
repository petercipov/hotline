Feature: Hotline should be able to
  ...
  Scenario: egress traffic is ingested, proxied and slos are computed
    ...
    Then service levels metrics are received in collector:
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency                 | Gauge | 5797.838  | ms   | breached:true; http_route:RKYKxFSFBkuxQ; integration_id:IN-dd0391f11aba; metric:p99.9 |
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_status                  | Gauge | 100.00    | %    | breached:false; http_route:RKYKxFSFBkuxQ; integration_id:IN-dd0391f11aba; metric:expected |
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_status_breakdown        | Gauge | 100.00    | %    | breached:false; breakdown:204; http_route:RKYKxFSFBkuxQ; integration_id:IN-dd0391f11aba; metric:expected |
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency_events          | Sum   | 331       | #    | breached:true; http_route:RKYKxFSFBkuxQ; integration_id:IN-dd0391f11aba; metric:p99.9                      |
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_status_breakdown_events | Sum   | 331       | #    | breached:false; breakdown:204; http_route:RKYKxFSFBkuxQ; integration_id:IN-dd0391f11aba; metric:expected |
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_status_events           | Sum   | 331       | #    | breached:false; http_route:RKYKxFSFBkuxQ; integration_id:IN-dd0391f11aba; metric:expected                |
