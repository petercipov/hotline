Feature: Hotline should be able to
  ...
  Scenario: egress traffic is ingested, proxied and slos are computed
        ...
        "routes": [
          {
            ...
            "definition": {
              "latency": {
                "percentiles": [{ "percentile": 99.9, "breachThreshold": "2s" }],
                "windowDuration": "1m0s"
              },
    ...
    Then slo metrics are received in collector:
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency                 | Gauge | 5797.838  | ms   | breached:true; http_route:DELETE:127.0.0.1::/bookings/{bookingId}; integration_id:IN-dd0391f11aba; metric:p99.9 |
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency_events          | Sum   | 330       | #    | breached:true; http_route:GET:127.0.0.1::/bookings; integration_id:IN-dd0391f11aba; metric:p99.9                                     |
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency_events          | Sum   | 331       | #    | breached:true; http_route:DELETE:127.0.0.1::/bookings/{bookingId}; integration_id:IN-dd0391f11aba; metric:p99.9                      |
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency_events          | Sum   | 339       | #    | breached:true; http_route:POST:127.0.0.1::/bookings; integration_id:IN-dd0391f11aba; metric:p99.9                                    |
