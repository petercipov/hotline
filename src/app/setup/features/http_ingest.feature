Feature: Hotline should be able to
  ...
  Scenario: Integration traffic is inspected and slos are computed
    ...
    Then slo metrics are received in collector:
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency                 | Gauge | 10140.455 | ms   | metric:p99; integration_id:IN-dd0391f11aba; breached:true; http_route:/                        |
      ...
      | 2025-02-22T12:02:20Z | service_levels_http_route_latency_events          | Sum   | 10000     | #    | metric:p99; breached:true; http_route:/; integration_id:IN-dd0391f11aba;                       |
